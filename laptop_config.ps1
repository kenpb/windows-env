...
$IP = "192.168.1.176" #  range 2-99 or 150-254 (this avoids any conflict with the default DHCP address range of 100-149).
...
Rename-Computer -computername (hostname) -newname kenpb-laptop; Restart-Computer -force
